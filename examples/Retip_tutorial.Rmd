...
# source("~/Documentos/Retip/R/model_automl.R")
...
if (build_models) {
  ...
  h2o::h2o.init(nthreads = -1)
  aml <- h2o.loadModel("automl_h2o_model/StackedEnsemble_BestOfFamily_1_AutoML_1_20240523_84024") ### add the name of your saved model
}
```
...
#> you want to visualize.
#> Last value is the title of the graphics.
Retip::p.model(testing, m = aml, title = "autoML - RIKEN PLASMA")
```
