...
author: "Paolo Bonini, Tobias Kind, Hiroshi Tsugawa, Dinesh Barupal and Oliver Fiehn"
date: "`r Sys.Date()`"
...
Visit Retip website to get all the information actualized [retip.app](https://www.retip.app)

Retip use 5 different machine learning algorithms to built a stable, accurate and fast RT prediction model:
...
3) The last option is the easiest one. We have computed for you more than 300k compounds to save your time and more important save electricity (we love nature). 
...
Once you get your prediction you can export to a format compatible with Mass spectrometry software.

Now we have available:

1) "MSDIAL": identification with accurate Mass and RTP (RECOMMENDED) [get MSDIAL](http://prime.psc.riken.jp/Metabolomics_Software/MS-DIAL/index2.html);
2) "MSFINDER": identification with accurate Mass, in silico fragmentation MS2 and RTP (RECOMMENDED) [get MSFINDER](http://prime.psc.riken.jp/Metabolomics_Software/MS-FINDER/index2.html);
3) "AGILENT": works with Mass Hunter software;
4) "THERMO";
5) "WATERS";
6) and soon "SCIEX".


You can also chose to export in positive or in negative mode.
