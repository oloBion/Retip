...
modelcv <- lightgbm::lgb.cv(params, dtrain, nrounds=5000,nfold = 10, valids,verbose = 1,
                            early_stopping_rounds = 1000, record = TRUE, eval_freq = 1L,
                            stratified = TRUE)
...
model <- lightgbm::lgb.train(params, dtrain, nrounds=best.iter, valids,verbose = 0,
                             early_stopping_rounds =1000, record = TRUE, eval_freq = 1L)
